...
include("includes/connection.php");
	...
	if(isset($_POST['sign_up'])){
		...
		$resume = htmlentities(mysqli_real_escape_string($con,$_POST['u_resume']));
		$status = "verified";
		$posts = "no";
		...
		$insert = "insert into users (f_name,l_name,user_name,describe_user,Relationship,user_pass,user_email,user_country,user_gender,user_birthday,u_resume,user_image,user_cover,user_reg_date,status,posts,recovery_account)
		values('$first_name','$last_name','$username','Manager of TCS ','...','$pass','$email','$country','$gender','$birthday','$resume','$profile_pic','default_cover.jpg',NOW(),'$status','$posts','Iwanttoputading intheuniverse.')";
