...
<body>
	<div class="row">
		<div class="col-sm-12">
			<div class="well">
				<center><h1 style="color: white;"><strong>Carrier Assist</strong></h1></center>
			</div>
		</div>
	</div>
		<div class="row">
			<div class="col-sm-6" style="left:0.5%;">
				<img src="images/codingcafe.jpeg" class="img-rounded" title="Carrier Assist" width="650px" height="565px">
				<div id="centered1" class="centered"><h3 style="color: white;"><span class="glyphicon glyphicon-search"></span>&nbsp&nbsp<strong>Follow Your Interests.</strong></h6></div>
			...
			<div class="col-sm-6" style="left: 8%;">
				...
				<h4><strong>Join Carrier Assist Today.</strong></h4>
