...
$con = mysqli_connect("localhost","root","","employee") or die("Connection was not established");
	...
	while($row_posts=mysqli_fetch_array($run_posts)){
		...
		if($content=="No" && strlen($upload_image) >= 1){
			...
			<div class='row'>
				...
				<a href='single.php?post_id=$post_id' style='float:right;'><button class='btn btn-info'>Commentsxahss</button></a><br>
				</div>
				<div class='col-sm-3'>
				</div>
			</div><br><br>
